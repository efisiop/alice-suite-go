...
| Consultant UX upgrades         | in-progress | user + agent | `docs/UPGRADE_ROADMAP.md`, `docs/AGENT_LOOP_INVENTORY.md`, `cmd/server/main.go`, `migrations/018_consultant_request_shares.sql`, `migrations/019_consultant_prompt_reading_reactions.sql`, `internal/database/consultant_assignments.go`, `internal/handlers/api.go`, `internal/services/help_service.go`, `internal/templates/consultant/help-requests.html`, `internal/templates/consultant/dashboard.html`, `internal/templates/consultant/readers.html`, `internal/templates/consultant/reader-inspector.html` (one-click, page-targeted AI prompt presets and reader emoji reactions) |
...
| AI assistance UX/readability   | in-progress | user + agent | `docs/UPGRADE_ROADMAP.md`, `docs/AI_ASSISTANT_FLOW_INVENTORY.md`, `docs/READER_FIX_LIST.md`, `internal/templates/reader/interaction.html`, `migrations/019_consultant_prompt_reading_reactions.sql` (prominent consultant AI suggestion card, larger linked-text starter actions, reader emoji experience replies)                                             |
