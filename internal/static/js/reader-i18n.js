...
(function() {
    ...
    const text = {
        ...
        'Use your camera on the page — the app will find it for you': 'Usa la fotocamera sulla pagina: l app la trovera per te',
        ...
        'The book text is in the middle. On the left you find sections, on the right your tools.': 'Il testo del libro e al centro. A sinistra trovi le sezioni, a destra i tuoi strumenti.',
        ...
        'The Mock Turtle is always sad because he used to be a real turtle. Carroll is playing with the dish "mock turtle soup"...': 'La Finta Tartaruga e sempre triste perche era una vera tartaruga. Carroll gioca con il piatto "mock turtle soup"...',
        'You can ask any question about the story': 'Puoi fare qualsiasi domanda sulla storia',
        'If something is not clear, ask the AI. It knows the book very well.': 'Se qualcosa non e chiaro, chiedi all AI. Conosce il libro molto bene.',
        ...
        'A reading consultant is available': 'Un consulente di lettura e disponibile',
        'If you need extra help, a real person can answer': 'Se hai bisogno di aiuto extra, una persona vera puo rispondere',
        ...
        'Start reading': 'Inizia a leggere',
        'The book stays in your hands. The app is here when you need it. If you feel lost, tap "Help" on any page.': 'Il libro resta nelle tue mani. L app e qui quando ne hai bisogno. Se ti senti perso, tocca "Aiuto" su qualsiasi pagina.',
        ...
        'Alice Suite is a companion for your physical copy of': 'Alice Suite e un compagno per la tua copia di',
        'Alice in Wonderland': 'Alice nel Paese delle Meraviglie',
        ...
        'Ask AI to explain a passage in simple words, or connect with a human consultant for deeper support.': 'Chiedi all AI di spiegare un passaggio con parole semplici oppure contatta un consulente per un aiuto piu approfondito.',
